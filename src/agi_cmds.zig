...
pub const agi_statements = [_]agi_statement_tuple{
    ...
    agi_statement_tuple{ .name = "toggle", .func = statements.agi_toggle, .arity = 1 },
    ...
    agi_statement_tuple{ .name = "toggle_v", .func = statements.agi_toggle_v, .arity = 1 },
    ...
    agi_statement_tuple{ .name = "end_of_loop", .func = statements.agi_end_of_loop, .arity = 2 },
